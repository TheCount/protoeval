...
type Value_Not struct {
	...
	Not *Value `protobuf:"bytes,24,opt,name=not,proto3,oneof"`
}
...
type Value_AllOf struct {
	...
	AllOf *Value_ValueList `protobuf:"bytes,25,opt,name=all_of,json=allOf,proto3,oneof"`
}
...
type Value_AnyOf struct {
	...
	AnyOf *Value_ValueList `protobuf:"bytes,26,opt,name=any_of,json=anyOf,proto3,oneof"`
}
...
type Value_Seq struct {
	...
	// seq yields nil.
	Seq *Value_ValueList `protobuf:"bytes,27,opt,name=seq,proto3,oneof"`
}
...
type Value_Eq struct {
	...
	Eq *Value_ValueList `protobuf:"bytes,28,opt,name=eq,proto3,oneof"`
}
...
type Value_Neq struct {
	...
	// It is an error if the non-ignored values do not have the same type.
	// If the list is empty or has only one element, the result is true.
	Neq *Value_ValueList `protobuf:"bytes,29,opt,name=neq,proto3,oneof"`
}
...
type Value_Lt struct {
	...
	// the result is true.
	Lt *Value_ValueList `protobuf:"bytes,30,opt,name=lt,proto3,oneof"`
}
...
type Value_Lte struct {
	...
	// Otherwise, if the list is empty or has only one element,
	// the result is true.
	Lte *Value_ValueList `protobuf:"bytes,31,opt,name=lte,proto3,oneof"`
}
...
type Value_Gt struct {
	...
	// Otherwise, if the list is empty or has only one element,
	// the result is true.
	Gt *Value_ValueList `protobuf:"bytes,32,opt,name=gt,proto3,oneof"`
}
...
type Value_Gte struct {
	...
	// Otherwise, if the list is empty or has only one element,
	// the result is true.
	Gte *Value_ValueList `protobuf:"bytes,33,opt,name=gte,proto3,oneof"`
}

type Value_Switch_ struct {
	// switch yields a value (based on scope) based on conditions.
	Switch *Value_Switch `protobuf:"bytes,34,opt,name=switch,proto3,oneof"`
}
...
type Value_While struct {
	...
	While *Value_Branch `protobuf:"bytes,35,opt,name=while,proto3,oneof"`
}
...
type Value_Break struct {
	...
	// count.
	Break uint32 `protobuf:"varint,36,opt,name=break,proto3,oneof"`
}
...
type Value_Continue struct {
	...
	// part do not count.
	Continue uint32 `protobuf:"varint,37,opt,name=continue,proto3,oneof"`
}
...
type Value_Store struct {
	...
	Store *Value_StoredValue `protobuf:"bytes,38,opt,name=store,proto3,oneof"`
}
...
var file_value_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x1b, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x14,
	...
	0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x1b, 0x0a, 0x08,
	0x62, 0x6f, 0x6f, 0x6c, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00,
	0x52, 0x07, 0x62, 0x6f, 0x6f, 0x6c, 0x4b, 0x65, 0x79, 0x12, 0x1b, 0x0a, 0x08, 0x75, 0x69, 0x6e,
	0x74, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x07, 0x75,
	0x69, 0x6e, 0x74, 0x4b, 0x65, 0x79, 0x12, 0x19, 0x0a, 0x07, 0x69, 0x6e, 0x74, 0x5f, 0x6b, 0x65,
	0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x06, 0x69, 0x6e, 0x74, 0x4b, 0x65,
	0x79, 0x12, 0x3a, 0x0a, 0x04, 0x74, 0x68, 0x69, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x48, 0x01, 0x52, 0x04, 0x74, 0x68, 0x69, 0x73, 0x12, 0x3e, 0x0a,
	0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e,
	...
	,
	...
	0x45, 0x6e, 0x75, 0x6d, 0x48, 0x01, 0x52, 0x04, 0x65, 0x6e, 0x75, 0x6d, 0x12, 0x3f, 0x0a, 0x04,
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x63, 0x6f, 0x6d,
	...
	,
	...
	0x1a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69, 0x74, 0x68,
	...
	0x65, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x01, 0x52, 0x05, 0x61, 0x6e, 0x79, 0x4f, 0x66, 0x12, 0x42,
	0x0a, 0x03, 0x73, 0x65, 0x71, 0x18, 0x1b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x63, 0x6f,
	...
	0x65, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x01, 0x52, 0x03, 0x73,
	0x65, 0x71, 0x12, 0x40, 0x0a, 0x02, 0x65, 0x71, 0x18, 0x1c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e,
	...
	0x52, 0x02, 0x65, 0x71, 0x12, 0x42, 0x0a, 0x03, 0x6e, 0x65, 0x71, 0x18, 0x1d, 0x20, 0x01, 0x28,
	...
	0x74, 0x48, 0x01, 0x52, 0x03, 0x6e, 0x65, 0x71, 0x12, 0x40, 0x0a, 0x02, 0x6c, 0x74, 0x18, 0x1e,
	...
	0x4c, 0x69, 0x73, 0x74, 0x48, 0x01, 0x52, 0x02, 0x6c, 0x74, 0x12, 0x42, 0x0a, 0x03, 0x6c, 0x74,
	0x65, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69,
	...
	,
	...
	,
	...
	0x12, 0x46, 0x0a, 0x04, 0x70, 0x72, 0x6f, 0x63, 0x18, 0x27, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30,
	0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x74, 0x68, 0x65, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x65, 0x76, 0x61, 0x6c, 0x2e, 0x56,
	...
	0x18, 0x28, 0x20, 0x01, 0x28, 0x09, 0x48, 0x01, 0x52, 0x04, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x1a,
	0x0a, 0x07, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x18, 0x29, 0x20, 0x01, 0x28, 0x09, 0x48,
	0x01, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x1a, 0x7c, 0x0a, 0x06, 0x42, 0x72,
	...
	0x70, 0x65, 0x42, 0x07, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x1f, 0x5a, 0x1d, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x54, 0x68, 0x65, 0x43, 0x6f, 0x75,
	0x6e, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x65, 0x76, 0x61, 0x6c, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_value_proto_depIdxs = []int32{
	...
	1,  // 9: com.github.thecount.protoeval.Value.not:type_name -> com.github.thecount.protoeval.Value
	9,  // 10: com.github.thecount.protoeval.Value.all_of:type_name -> com.github.thecount.protoeval.Value.ValueList
	9,  // 11: com.github.thecount.protoeval.Value.any_of:type_name -> com.github.thecount.protoeval.Value.ValueList
	9,  // 12: com.github.thecount.protoeval.Value.seq:type_name -> com.github.thecount.protoeval.Value.ValueList
	9,  // 13: com.github.thecount.protoeval.Value.eq:type_name -> com.github.thecount.protoeval.Value.ValueList
	9,  // 14: com.github.thecount.protoeval.Value.neq:type_name -> com.github.thecount.protoeval.Value.ValueList
	9,  // 15: com.github.thecount.protoeval.Value.lt:type_name -> com.github.thecount.protoeval.Value.ValueList
	9,  // 16: com.github.thecount.protoeval.Value.lte:type_name -> com.github.thecount.protoeval.Value.ValueList
	9,  // 17: com.github.thecount.protoeval.Value.gt:type_name -> com.github.thecount.protoeval.Value.ValueList
	9,  // 18: com.github.thecount.protoeval.Value.gte:type_name -> com.github.thecount.protoeval.Value.ValueList
	8,  // 19: com.github.thecount.protoeval.Value.switch:type_name -> com.github.thecount.protoeval.Value.Switch
	2,  // 20: com.github.thecount.protoeval.Value.while:type_name -> com.github.thecount.protoeval.Value.Branch
	7,  // 21: com.github.thecount.protoeval.Value.store:type_name -> com.github.thecount.protoeval.Value.StoredValue
	7,  // 22: com.github.thecount.protoeval.Value.proc:type_name -> com.github.thecount.protoeval.Value.StoredValue
	1,  // 23: com.github.thecount.protoeval.Value.Branch.case:type_name -> com.github.thecount.protoeval.Value
	1,  // 24: com.github.thecount.protoeval.Value.Branch.then:type_name -> com.github.thecount.protoeval.Value
	0,  // 25: com.github.thecount.protoeval.Value.List.kind:type_name -> com.github.thecount.protoeval.Value.Kind
	1,  // 26: com.github.thecount.protoeval.Value.List.values:type_name -> com.github.thecount.protoeval.Value
	0,  // 27: com.github.thecount.protoeval.Value.Map.key_kind:type_name -> com.github.thecount.protoeval.Value.Kind
	0,  // 28: com.github.thecount.protoeval.Value.Map.value_kind:type_name -> com.github.thecount.protoeval.Value.Kind
	10, // 29: com.github.thecount.protoeval.Value.Map.entries:type_name -> com.github.thecount.protoeval.Value.Map.Entry
	11, // 30: com.github.thecount.protoeval.Value.Message.fields:type_name -> com.github.thecount.protoeval.Value.Message.FieldsEntry
	1,  // 31: com.github.thecount.protoeval.Value.StoredValue.value:type_name -> com.github.thecount.protoeval.Value
	2,  // 32: com.github.thecount.protoeval.Value.Switch.cases:type_name -> com.github.thecount.protoeval.Value.Branch
	1,  // 33: com.github.thecount.protoeval.Value.Switch.default:type_name -> com.github.thecount.protoeval.Value
	1,  // 34: com.github.thecount.protoeval.Value.ValueList.values:type_name -> com.github.thecount.protoeval.Value
	1,  // 35: com.github.thecount.protoeval.Value.Map.Entry.key:type_name -> com.github.thecount.protoeval.Value
	1,  // 36: com.github.thecount.protoeval.Value.Map.Entry.value:type_name -> com.github.thecount.protoeval.Value
	1,  // 37: com.github.thecount.protoeval.Value.Message.FieldsEntry.value:type_name -> com.github.thecount.protoeval.Value
